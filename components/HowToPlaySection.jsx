      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-600 text-lg leading-relaxed">
            امزج بين الذكاء والفروسية والتخطيط الحربي الدقيق. تعرّف على الخطوات
            اللوجيستية لتوزيع جيشك والهجوم بسلاح التفكير.
          </p>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-8 md:p-12 shadow-md">
          <div className="max-w-3xl mx-auto text-center mb-10">
            <h3 className="text-2xl md:text-3xl font-bold text-slate-900">
              وسائل المساعدة اللوجيستية
            </h3>
            <p className="text-slate-500 mt-2 text-md">
              الذخيرة البديلة التي تضمن الفوز في أصعب المواقف الثقافية. استخدمها
              بحكمة بالغة لتقلب الموازين.
            </p>
          </div>
