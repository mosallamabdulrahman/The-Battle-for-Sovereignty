            ...
            <div>
              <div className="flex items-center justify-between border-b border-slate-200 pb-4 mb-8">
                <div className="flex items-center gap-3">
                  <span className="w-8 h-8 rounded-full bg-cyan-600 text-white font-bold text-sm flex items-center justify-center">
                    ١
                  </span>
                  <div>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-gradient-to-tr from-cyan-50/30 to-cyan-100/10 p-6 rounded-2xl border border-cyan-100 flex flex-col items-center">
                ...
                <h4 className="font-sans font-bold text-sm text-cyan-800 mt-4">
                  رابط دخول {createdRoom.team_1_name}
                </h4>
                ...
                <div className="flex gap-2.5 mt-3.5 w-full">
                  <button
                    ...
                    className="flex-1 bg-white hover:bg-slate-50 border border-slate-200 text-slate-700 py-1.5 px-3 rounded-lg flex items-center justify-center gap-1.5 text-[11px] font-bold cursor-pointer transition-colors"
                  >
              ...
              <div className="bg-gradient-to-tr from-orange-50/30 to-orange-100/10 p-6 rounded-2xl border border-orange-100 flex flex-col items-center">
                ...
                <h4 className="font-sans font-bold text-sm text-orange-850 mt-4">
                  رابط دخول {createdRoom.team_2_name}
                </h4>
                <p className="text-[10px] text-slate-500 mt-1 line-clamp-1 max-w-[240px]">
