...
// Content groups (التصنيفات) — the tier above question categories. Ordered by
// creation so the panel list and the home-page sections agree.
export const loadAllCategoryGroups = (supabaseAdmin) =>
  fetchAllRows(() =>
    supabaseAdmin
