...
export const TACTICAL_TOOL_DETAILS = {
  radar_scan: {
    name: "مسح الرادار",
    description: "يكشف المربع المختار وكل المربعات المحيطة به (3×3). اضغط مربعًا على خريطة الخصم.",
  },
  shield: {
    name: "الدرع",
    description: "يصد أول ضربة ناجحة على وحداتك. يجب تفعيله قبل كشف السؤال.",
  },
  extra_strike: {
    name: "ضربة إضافية",
    description: "يضيف ضربة واحدة لرصيدك. يجب تفعيله قبل كشف السؤال.",
  },
  lifeline_call: {
    name: "اتصال بصديق",
